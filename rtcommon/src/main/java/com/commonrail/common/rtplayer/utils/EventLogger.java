package com.commonrail.common.rtplayer.utils;
 ...
 */
public class EventLogger implements RtPlayerListener, InfoListener, InternalErrorListener {
    ...
    public EventLogger() {
        loadStartTimeMs = new long[RtPlayer.RENDERER_COUNT];
    }
